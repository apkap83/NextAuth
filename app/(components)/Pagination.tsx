...
const Pagination = ({ totalItems, pageSize, activePage, onPageChange }) => {
...
function PaginationNumber({ page, isActive, position, onPageChange }) {
...
function PaginationArrow({ direction, isDisabled, activePage, onPageChange }) {
  const className = clsx(
